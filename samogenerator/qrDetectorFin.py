...
def mainCovidLoop(video_stream):
    ...
    # cv2.putText(frame, ts, (10, frame.shape[0] - 460), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 0, 255), 1)
    # qr_text = "Skeniraj QR kodo"
    # cv2.putText(frame, qr_text, (150, frame.shape[0] - 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)

    qrdata = barcodeDetector(frame)
    if qrdata:
        decodeddata, jsontype = decodeCovid(qrdata)
