...
def mainMrzLoop(video_stream):
    ...
    # cv2.putText(image, ts, (10, image.shape[0] - 460), cv2.FONT_HERSHEY_SIMPLEX, 0.35, (0, 0, 255), 1)
    # qr_text = "Skeniraj osebno izkaznico"
    # cv2.putText(image, qr_text, (150, image.shape[0] - 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
